...
# # Usage
# root = tk.Tk()
# root.geometry("800x600")  # Set this to the desired size, or maximize window to fit the screen

# image_path = "patchnova\patch_nova.jpg"  # Update this to the path of your image
